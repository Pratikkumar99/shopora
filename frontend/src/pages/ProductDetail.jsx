...
const ProductDetail = () => {
  ...
  if (loading) return <div style={{ textAlign: 'center', margin: '100px', color: '#1DB954' }}>Loading Product...</div>;
  ...
  return (
    <div className="product-detail-wrapper" style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      ...
      <div style={{ color: '#a1a1aa', marginBottom: '20px', fontSize: '0.95rem' }}>
        <Link to="/" style={{ color: '#1DB954' }}>Home</Link> / <Link to="/shop" style={{ color: '#1DB954' }}>Shop</Link> / {product.category} / <span style={{ color: '#fff' }}>{product.name}</span>
      </div>
