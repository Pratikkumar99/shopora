...
const Profile = () => {
  ...
  const badgeStyle = { background: 'rgba(29,185,84,0.1)', color: '#1DB954', padding: '6px 12px', borderRadius: '8px', fontSize: '0.9rem', fontWeight: 'bold', display: 'inline-block' };
  ...
  return (
    <div style={containerStyle}>
      ...
      <h3 style={{ color: '#1DB954', marginBottom: '20px', fontSize: '1.5rem' }}>Order History</h3>
      {loading ? (
